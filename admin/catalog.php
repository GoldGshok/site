...
<?php
  ...
  if (isset($_GET['rewrite']))
  {
    ...
    print "<p>Описание <textarea type='text' name='Note' rows='10' cols='50'/>$note</textarea></p>";
  ...
  if (isset($_GET['add']))
  {
    ...
    print "<p>Описание <textarea type='text' name='Note' rows='10' cols='50'/></textarea></p>";
  ...
  while ($row = $result->fetch_assoc()) 
  {
    ...
    printf("<tr>
      ...
      $row["Buy_Cost"],
      $row["Sell_Cost"],
      "<a href='?rewrite=$id'><img src='../images/edit.png' width='20' height='20'/></a>",
      "<a href='?delete=$id'><img src='../images/delete.png' width='20' height='20'/></a>");
  }
  print '</tbody></table>';
  print "<a href='?add'><img src='../images/add.png' width='20' height='20'/></a>";
